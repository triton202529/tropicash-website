...
export const developersPrimaryLinkClass = cn(
...
export const developersSecondaryLinkClass = cn(
...
export const developersPrimaryLinkWideClass = cn(
  developersPrimaryLinkClass,
  "w-full sm:w-auto px-8",
);

export const developersSecondaryLinkWideClass = cn(
