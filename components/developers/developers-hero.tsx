...
import {
  developersPrimaryLinkClass,
  developersSecondaryLinkClass,
} from "./developers-links";

const heroStack = [
  { label: "App registration", chip: "Foundation" },
  { label: "API access", chip: "Readiness" },
  { label: "OAuth readiness", chip: "Planned path" },
  { label: "Webhook events", chip: "Events" },
  { label: "Sandbox environment", chip: "Sandbox-first" },
] as const;
    ...
    >
      ...
      <div className="relative grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
        <div>
          ...
          >
            Build Caribbean payment experiences on Tropicash.
          </h1>

          <p className="mt-6 max-w-xl text-lg leading-relaxed text-surface-light-muted">
            Tropicash is preparing developer tools for wallet integrations,
            merchant payments, app authorization, webhooks, and sandbox-first
            financial experiences across the Caribbean.
          </p>
