...
const heroLayers = [
  { label: "Send money", chip: "Wallet" },
  { label: "Receive money", chip: "Wallet" },
  { label: "Fund wallet", chip: "Wallet" },
  { label: "Manage balance", chip: "Wallet" },
    ...
    >
      ...
      <div className="relative grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
        <div>
          ...
          >
            A Caribbean-first wallet and payment platform being built for
            everyday money movement.
          </h1>

          <p className="mt-6 max-w-xl text-lg leading-relaxed text-surface-light-muted">
            Tropicash is being designed to help people send money, receive
            money, fund wallets, manage balances, and connect with businesses,
            developers, and trusted partners through secure payment
            infrastructure.
          </p>

          <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:items-center">
            <Link href="/platform" className={aboutPrimaryLinkClass}>
              Explore Platform
            </Link>
            <Link href="/contact" className={aboutSecondaryLinkClass}>
              Contact Tropicash
            </Link>
          </div>
        </div>
