...
export const platformPrimaryLinkClass = cn(
...
export const platformSecondaryLinkClass = cn(
...
export const platformPrimaryLinkWideClass = cn(
  platformPrimaryLinkClass,
  "w-full sm:w-auto px-8",
);

export const platformSecondaryLinkWideClass = cn(
