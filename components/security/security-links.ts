...
export const securityPrimaryLinkClass = cn(
...
export const securitySecondaryLinkClass = cn(
...
export const securityPrimaryLinkWideClass = cn(
  securityPrimaryLinkClass,
  "w-full sm:w-auto px-8",
);

export const securitySecondaryLinkWideClass = cn(
