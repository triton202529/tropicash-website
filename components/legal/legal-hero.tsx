...
import {
  ...
  legalSecondaryLinkClass,
} from "./legal-links";

const heroLayers = [
  { label: "Website notices", chip: "Active" },
  { label: "Development-stage information", chip: "Active" },
  { label: "Product terms planned", chip: "Planned" },
  { label: "Privacy policy planned", chip: "Planned" },
  { label: "Partner agreements planned", chip: "Planned" },
] as const;
    ...
    >
      ...
      <div className="relative grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
        <div>
          ...
          >
            Legal information for the Tropicash corporate website.
          </h1>

          <p className="mt-6 max-w-xl text-lg leading-relaxed text-surface-light-muted">
            This page provides general website notices and development-stage
            information for Tropicash. Formal product terms, privacy policies,
            financial service disclosures, and partner agreements will be
            prepared before any production service launch.
          </p>

          <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:items-center">
            <Link href="/contact" className={legalPrimaryLinkClass}>
              Contact Tropicash
            </Link>
            <Link href="/platform" className={legalSecondaryLinkClass}>
              View Platform
            </Link>
          </div>
        </div>
